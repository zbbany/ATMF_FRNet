...
if __name__=='__main__':
    ...
    model  = args.model
    ckpt   = args.ckpt
    example_input = torch.randn(1, 3, 352, 352)
    
    print(args.model, args.ckpt)

    if args.task == "SOD":
        for path in ['datasets/ECSSD/Test', 'datasets/PASCAL-S/Test', 'datasets/DUTS/Test', 'datasets/HKU-IS/Test',
                     'datasets/DUT-OMRON/Test', 'datasets/SOD/Test']:
