...
def train(Dataset, parser):
    ...
    for epoch in range(cfg.epoch):
        ...
        for step, (image, mask) in enumerate(loader):
            ...
            scaler.scale(image).cuda()  # Dummy operation to trigger the scaler context manager
        ...
        if epoch > -1:
            ...
            for path in ['datasets/ECSSD/Test', 'datasets/PASCAL-S/Test']:
                ...
                t.save()
            # Assuming the following line runs a validation script
    ...
    def save(self):
        with torch.no_grad():
            for image, (H, W), name in self.loader:
                ...
                out1, out2, out3, out4 = self.net(image, shape)
